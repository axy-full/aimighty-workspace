...
10. Mobile: Atomik sheet (§14, board 9c).
...
## 14. Mobile (board 9c) — below 768px

Atomik's checkpoint is a **sheet**: ring 88px, eyebrow, 26px headline (`Boards done.` / `12 cr spent.`), one sentence of what's next, `NEXT STEP · 24 cr` row, primary `Continue · 24 CR` (54px), `Change engine` / `Stop here` (46px), mono `19 OF 253 CR · PLANNING 3 CR`. Nothing else in the sheet. Tap targets ≥ 44pt; no text below 12px. Other mobile screens follow the desktop spec with a bottom dock `Needs you · Make · Productions`.
