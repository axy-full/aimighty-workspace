...
function Workspace({ project, onChange, assetPreviews = EMPTY_PREVIEWS, assistant, exportPanel }: AstraBlenderWorkspaceProps) {
  ...
  return <section className={styles.workspace} aria-label="Astra" data-mobile-tab={mobileTab} onKeyDown={(event) => {
    ...
    <header className={styles.header}>
      <div className={styles.brand}><span className={styles.brandIcon}><Box size={19} /></span><div><h1>Astra</h1><p>{project.name} <ChevronRight size={10} /> 3D workspace</p></div></div>
