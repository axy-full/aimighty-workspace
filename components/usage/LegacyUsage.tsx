...
/* The pre-v2 Usage page, kept for the studio's own dollar workspaces (no credits: vendor ledgers, readings, top-ups). Credit workspaces get app/(app)/usage/page.tsx (SOW v2 §7.12, board 12f). */
...
export default function LegacyUsage() {
