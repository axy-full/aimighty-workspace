...
export default function ConsumerVideoVerification() {
  ...
  async function act(action: "quote-rehearsal" | "submit" | "status") {
    ...
    try {
      ...
      if (result.providerStatus !== undefined) setProviderStatus(result.providerStatus);
