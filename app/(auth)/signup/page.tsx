...
function Signup() {
  ...
  return (
    <AuthCard title="Create your workspace" sub={`For ${state.email}. Your workspace gets its own database and team, with the engines already connected and a welcome grant of credits — add your own vendor keys whenever you want to pay them directly. You own it.`}>
