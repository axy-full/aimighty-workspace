/**
 * The four items (design/particl-v2/README.md §1, reordered by
 * docs/change-request-1.md §9): Make · Library · Productions · Rig — the
 * Library is the asset home; Productions consume it. Usage and Settings
 * live in the account menu, and nowhere else.
 *
...
/** The phone's dock (design/particl-v2-mobile/README.md, board M1; CR1 §9 order): `Make · LIBRARY · PRODS · Rig` — the four nav items, Productions written short. */
