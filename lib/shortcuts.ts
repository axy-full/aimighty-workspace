...
export const SHORTCUTS: Shortcut[] = [
  ...
  { id: "rigadd",    keys: "⌘K",   label: "Add a node",            scope: "rig",     live: true,  owner: "Canvas" },
  { id: "rigremove", keys: "⌫",    label: "Remove the selected node", scope: "rig",  live: true,  owner: "Canvas" },
  { id: "rigopen",   keys: "⌘R",   label: "Open the shot in Rig",  scope: "rig",     live: true,  owner: "Shots grid" },
