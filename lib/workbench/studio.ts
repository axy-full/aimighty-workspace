...
export type Production = { scriptApproval?: ScriptApproval; beats?: import('../production/beats').BeatSheet; boards?: import('../production/boards').Boards; cast?: import('../production/cast').Cast; environment?: import('../production/environment').Environment };
