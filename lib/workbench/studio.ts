...
export type Asset = { id:string; name:string; kind:AssetKind; category:string; url:string; description:string; prompt:string; status:AssetStatus; locked:boolean; version:number; refs:string[]; parentId?:string; mime?:string; uploadId?:string; generationId?:string; soulIdentityId?:string; productionShotId?:string; nodeId?:string; /** The workspace-template name an export gives this file, without extension (lib/workbench/export-names.ts). */ exportName?:string; /** The stored original's own length in seconds (audio and video), when the server could read it. */ seconds?:number };
...
export type Production = { scriptApproval?: ScriptApproval; beats?: import('../production/beats').BeatSheet; boards?: import('../production/boards').Boards; cast?: import('../production/cast').Cast; environment?: import('../production/environment').Environment; beatSource?: import('../production/beats').BeatSource };
