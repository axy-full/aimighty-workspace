...
export default defineConfig({
  testDir: "tests",
  testMatch:
    /(account-security|pipelines|gen|customer|composer-audio|composer-batch|paid-action|recovery-race|upload-recovery|workspace-audit|management-scope)\.spec\.ts$/,
  timeout: 90_000,
